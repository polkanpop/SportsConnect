...
const styles = StyleSheet.create({
  ...
  kindBadgeText: { fontSize: 12, fontWeight: '700', color: '#0F172A' },
  statusBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 999 },
  statusBadgeText: { fontSize: 12, fontWeight: '700' },
  timeText: { color: '#64748B', fontSize: 12, fontWeight: '500' },
  title: { marginTop: 10, fontSize: 14, fontWeight: '700', color: '#0F172A' },
  scheduleWrap: { marginTop: 6, gap: 2 },
  scheduleText: { fontSize: 12, fontWeight: '500', color: '#64748B' },
  subtitle: { marginTop: 4, fontSize: 14, fontWeight: '700', color: '#475569' },
  metaText: { marginTop: 4, fontSize: 12, fontWeight: '500', color: '#64748B' },
  amount: { marginTop: 8, color: '#0F172A', fontWeight: '700', fontSize: 14 },
