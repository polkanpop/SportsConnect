    ...
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.searchRow}>
        <View style={styles.searchContainer}>
          ...
          <TextInput placeholder='Search sessions...' placeholderTextColor={'#777'} value={search} onChangeText={setSearch} style={styles.searchInput} />
        </View>
      </View>
          ...
          {filteredSessions.slice(0, visibleCount).map(s => {
            ...
            return (
              ...
              >
                ...
                <View style={styles.cardRight}><View style={styles.placeholderImg} /><Image source={ICONS.arrowright} style={styles.arrowIcon} /></View>
              </TouchableOpacity>
            )
          })}
        </ScrollView>
